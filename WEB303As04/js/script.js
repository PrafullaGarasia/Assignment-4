...
$(function () 
{
    ...
    if(old_lon == null || old_lat == null)
    {
        ...
        $('div#locationhere').text("We cannot display your coordinates unless you allow access to your location");
        });
    ...
    else
    {
        ...
        str1 = str1 + "<br><h2>distance from new to old is</h2> " + distance + " km" ;
